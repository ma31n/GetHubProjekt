...
function Java() {
  return (
    <div className="Java">
        ...
        <div className="post"><h2 align="center">How to make a number guessing game</h2>
        <textarea className="code2" value='package guessinggame;
...
public class GuessingGame {
    ...
    public static String determineGuess(int userAnswer, int computerNumber, int count){
        ...
        <div className="post"><h2 align="center">How to make a currency converter</h2>
        <textarea className="code2" value='
133
134
135
136
